 ...
 * management implementation ({@link frp.utn.tp.security.AppUserInfo},
 * {@link frp.utn.tp.security.CurrentUser})</li>
 * <li>A value object for identifying users ({@link frp.utn.tp.security.domain.UserId})</li>
 * <li>Method-level security and JPA auditing ({@link frp.utn.tp.security.CommonSecurityConfig})</li>
